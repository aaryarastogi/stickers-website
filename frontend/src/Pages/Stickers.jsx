              ...
              {stickers.map((sticker) => (
                <div key={sticker.id} className="flex flex-col">
                  ...
                  <div 
                    ...
                    onClick={() => navigate(`/sticker/template/${sticker.id}`)}
                  >
                    {/* Sticker Image */}
                    <img
                  ...
                  <div className="mt-3">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col items-end">
                        <span className="text-gray-600 text-sm font-semibold mb-2">{formatPrice(parseFloat(sticker.price))}</span>
