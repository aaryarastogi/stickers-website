...
const CustomStickerCreator = () => {
  ...
  const [stickerCategory, setStickerCategory] = useState('uncategorized')
  ...
  const handleFile = async (file) => {
    ...
    try {
      ...
      // Generate sticker name if not already set
      if (!stickerName.trim()) {
  ...
  const handlePayNow = async () => {
    ...
    const finalStickerName = stickerName.trim() || generateStickerName()
    const finalCategory = stickerCategory.trim() || 'uncategorized'
    ...
    try {
      ...
      const paymentResponse = await openRazorpayCheckout(
        ...
        },
        {
          ...
          description: `Payment for custom sticker: ${finalStickerName}`,
      ...
      setImagePreview(null)
      setStickerName('')
      setStickerCategory('uncategorized')
      setQuantity(1)
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Enter a name for your sticker (optional)"
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-purple-500 focus:outline-none transition-colors"
                  />
                  {!stickerName.trim() && (
                    <p className="mt-1 text-sm text-gray-500">
                      A default name will be generated automatically
                    </p>
                  )}
                </div>
